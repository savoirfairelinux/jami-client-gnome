...
const backBottomContainer = document.getElementById('backBottomContainer')
...
function set_titles() {
    ...
    backBottom.innerHTML = `${i18n.gettext('Jump to latest')} &#9660;`
...
function onScrolled_() {
    ...
    if(messages.scrollTop >= messages.scrollHeight - messages.clientHeight - scrollDetectionThresh) {
        // fade out
        if (!backBottom.classList.contains('fade')) {
            backBottom.classList.add('fade')
            backBottom.style.visibility = 'hidden'
            backBottomContainer.style.visibility = 'hidden'
            backBottom.removeAttribute("onclick")
        }
    } else {
        // fade in
        if (backBottom.classList.contains('fade')) {
            backBottom.style.visibility = "visible"
            backBottomContainer.style.visibility = "visible"
            backBottom.classList.remove('fade')
            backBottom.onclick = back_to_bottom
        }
    }
