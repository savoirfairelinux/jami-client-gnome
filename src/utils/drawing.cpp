...
static constexpr GdkRGBA     COLOR_PALETTE[] = {{0.956862, 0.262745, 0.211764, 1.0},
                                                {0.913725, 0.117647, 0.388235, 1.0},
                                                {0.611764, 0.152941, 0.690196, 1.0},
                                                {0.403921, 0.227450, 0.717648, 1.0},
                                                {0.247058, 0.317647, 0.709803, 1.0},
                                                {0.129411, 0.588235, 0.952941, 1.0},
                                                {0, 0.838254, 0.831372, 1.0},
                                                {0, 0.588235, 0.533333, 1.0},
                                                {0.298039, 0.682745, 0.313725, 1.0},
                                                {0.545098, 0.764705, 0.290196, 1.0},
                                                {0.619607, 0.619607, 0.619607, 1.0},
                                                {0.803921, 0.862745, 0.223529, 1.0},
                                                {1, 0.756862, 0.027450, 1.0},
                                                {1, 0.341176, 0.133333, 1.0},
                                                {0.474509, 0.333333, 0.282352, 1.0},
                                                {0.376470, 0.490196, 0.545098, 1.0}};
