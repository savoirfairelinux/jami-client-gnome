...
static constexpr int VIDEO_WIDTH = 450; /* px */
static constexpr int VIDEO_HEIGHT = 300; /* px */
...
selfie_view_class_init(SelfieViewClass *klass)
{
    ...
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS (klass), SelfieView, display_pic);
...
{
    // note: this function doesn't check if the state transition is valid, this is assumed to have
