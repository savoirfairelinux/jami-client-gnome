...
class DBusErrorHandler : public DBusErrorDelegate {
public:
    virtual void connectionError(const QString& error) override;
    virtual void invalidInterfaceError(const QString& error) override;
