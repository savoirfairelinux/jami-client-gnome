                      ...
                      G_GNUC_UNUSED gpointer data)
{
    ...
    if (uris && *uris)
        Video::SourceModel::SourceModelFromSelectedCall()->setFile(QUrl(*uris));
...
{
    Video::SourceModel::SourceModelFromSelectedCall()->switchTo(device);
}
...
switch_video_input_screen(G_GNUC_UNUSED GtkWidget *item, G_GNUC_UNUSED gpointer user_data)
{
    ...
    Video::SourceModel::SourceModelFromSelectedCall()->setDisplay(display, QRect(x,y,width,height));
}
...
switch_video_input_file(G_GNUC_UNUSED GtkWidget *item, GtkWidget *parent)
{
    ...
    if (gtk_dialog_run(GTK_DIALOG(dialog)) == GTK_RESPONSE_ACCEPT) {
        ...
        Video::SourceModel::SourceModelFromSelectedCall()->setFile(QUrl(uri));
    }
                                ...
                                G_GNUC_UNUSED gpointer data)
{
    ...
    auto active = Video::SourceModel::SourceModelFromSelectedCall()->activeIndex();
    ...
    for( auto device: device_list) {
        ...
        auto device_idx =  Video::SourceModel::SourceModelFromSelectedCall()->getDeviceIndex(device);
