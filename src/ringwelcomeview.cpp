...
ring_welcome_view_init(RingWelcomeView *self)
{
    ...
    PangoAttribute *font_desc_ringid = pango_attr_font_desc_new(pango_font_description_from_string("12"));
    pango_attr_list_insert(attrs_ringid, font_desc_ringid);
    gtk_label_set_attributes(GTK_LABEL(label_welcome_text), attrs_ringid);
