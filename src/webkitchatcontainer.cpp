...
init_js_i18n(WebKitChatContainer *view)
{
    ...
    /* FIXME handle language variants, e.g. fr_BE -> fr
       use g_get_locale_variants() ? */
    auto res = g_strdup_printf("/net/jami/JamiGnome/i18n/%s.json", lang);
