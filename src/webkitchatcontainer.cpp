...
build_view(WebKitChatContainer *view)
{
    ...
    WebKitUserStyleSheet* bootstrap_style_sheet = webkit_user_style_sheet_new(
        (gchar*) g_resources_lookup_data(
            "/cx/ring/RingGnome/bootstrap.css",
    ...
    webkit_user_content_manager_add_style_sheet(webkit_content_manager, bootstrap_style_sheet);
