...
{
    PendingContactRequestsViewPrivate *priv = PENDING_CONTACT_REQUESTS_VIEW_GET_PRIVATE(self);
...
{
    PendingContactRequestsView *self = PENDING_CONTACT_REQUESTS_VIEW(object);
    PendingContactRequestsViewPrivate *priv = PENDING_CONTACT_REQUESTS_VIEW_GET_PRIVATE(self);
