...
draw_codecs(NewAccountSettingsView* view)
{
    ...
    // Clear video codecs
    gtk_container_forall(GTK_CONTAINER(priv->list_video_codecs), (GtkCallback)remove_cb, priv->list_video_codecs);
    // Add video codecs
    ...
    // Clear audio codecs
    gtk_container_forall(GTK_CONTAINER(priv->list_audio_codecs), (GtkCallback)remove_cb, priv->list_audio_codecs);
    // Add audio codecs
