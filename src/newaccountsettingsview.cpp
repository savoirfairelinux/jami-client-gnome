...
struct _NewAccountSettingsViewPrivate
{
    ...
    GtkWidget* call_allow_switch;
    GtkWidget* auto_answer_switch;
    GtkWidget* entry_name_server;
    GtkWidget* entry_dht_proxy;
    GtkWidget* dht_proxy_switch;
...
new_account_settings_view_class_init(NewAccountSettingsViewClass *klass)
{
    ...
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS(klass), NewAccountSettingsView, call_allow_switch);
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS(klass), NewAccountSettingsView, auto_answer_switch);
    ...
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS(klass), NewAccountSettingsView, dht_proxy_switch);
    ...
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS(klass), NewAccountSettingsView, upnp_switch);
}
...
update_allow_call(GtkWidget*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->allowIncomingFromTrusted = gtk_switch_get_active(GTK_SWITCH(priv->call_allow_switch));
    new_account_settings_view_save_account(view);
}
...
update_auto_answer(GtkWidget*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->autoAnswer = gtk_switch_get_active(GTK_SWITCH(priv->auto_answer_switch));
    new_account_settings_view_save_account(view);
}
...
update_nameserver(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->RingNS.uri = gtk_entry_get_text(GTK_ENTRY(priv->entry_name_server));
    new_account_settings_view_save_account(view);
...
update_dhtproxy(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->proxyServer = gtk_entry_get_text(GTK_ENTRY(priv->entry_dht_proxy));
    new_account_settings_view_save_account(view);
...
enable_dhtproxy(GtkWidget*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->proxyEnabled = gtk_switch_get_active(GTK_SWITCH(priv->dht_proxy_switch));
    new_account_settings_view_save_account(view);
}
...
enable_turn(GtkWidget*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->TURN.enable = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(priv->checkbutton_use_turn));
    new_account_settings_view_save_account(view);
}
...
update_turnserver(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->TURN.server = gtk_entry_get_text(GTK_ENTRY(priv->entry_turnserver));
    new_account_settings_view_save_account(view);
...
update_turnpassword(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->TURN.password = gtk_entry_get_text(GTK_ENTRY(priv->entry_turnpassword));
    new_account_settings_view_save_account(view);
...
update_turnusername(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->TURN.username = gtk_entry_get_text(GTK_ENTRY(priv->entry_turnusername));
    new_account_settings_view_save_account(view);
...
update_turnrealm(GtkWidget*, GdkEvent*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->TURN.realm = gtk_entry_get_text(GTK_ENTRY(priv->entry_turnrealm));
    new_account_settings_view_save_account(view);
...
enable_upnp(GtkWidget*, NewAccountSettingsView *view)
{
    ...
    priv->currentProp_->upnpEnabled = gtk_switch_get_active(GTK_SWITCH(priv->upnp_switch));
    new_account_settings_view_save_account(view);
}
...
build_settings_view(NewAccountSettingsView* view)
{
    ...
    g_signal_connect_swapped(priv->call_allow_switch, "activate", G_CALLBACK(update_allow_call), view);
    g_signal_connect_swapped(priv->auto_answer_switch, "activate", G_CALLBACK(update_auto_answer), view);
    ...
    g_signal_connect_swapped(priv->dht_proxy_switch, "activate", G_CALLBACK(enable_dhtproxy), view);
    g_signal_connect_swapped(priv->checkbutton_use_turn, "toggled", G_CALLBACK(enable_turn), view);
    ...
    g_signal_connect_swapped(priv->upnp_switch, "activate", G_CALLBACK(enable_upnp), view);
...
new_account_settings_view_update(NewAccountSettingsView *view)
{
    ...
    gtk_switch_set_active(GTK_SWITCH(priv->call_allow_switch), priv->currentProp_->allowIncomingFromTrusted);
    gtk_switch_set_active(GTK_SWITCH(priv->auto_answer_switch), priv->currentProp_->autoAnswer);
    ...
    gtk_switch_set_active(GTK_SWITCH(priv->dht_proxy_switch), priv->currentProp_->proxyEnabled);
    ...
    gtk_switch_set_active(GTK_SWITCH(priv->upnp_switch), priv->currentProp_->upnpEnabled);
}
