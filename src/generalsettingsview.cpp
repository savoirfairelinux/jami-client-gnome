...
general_settings_view_init(GeneralSettingsView *self)
{
    ...
    g_settings_bind(priv->settings, "history-limit",
                    ...
                    G_SETTINGS_BIND_DEFAULT);
    g_settings_bind(priv->settings, "record-local-video",
                    priv->record_preview_button, "active",
                    G_SETTINGS_BIND_DEFAULT);
    g_settings_bind(priv->settings, "always-record",
                    priv->always_record_button, "active",
                    G_SETTINGS_BIND_DEFAULT);
    g_settings_bind(priv->settings, "record-quality",
                    priv->adjustment_record_quality, "value",
                    G_SETTINGS_BIND_DEFAULT);
...
general_settings_view_new(GtkWidget* ring_main_window_pointer)
{
    ...
    g_signal_connect_swapped(priv->button_choose_record_directory, "clicked", G_CALLBACK(choose_record_directory), view);
