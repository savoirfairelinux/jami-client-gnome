...
struct _GeneralSettingsViewPrivate
{
    ...
    GtkWidget *checkbutton_quitonclose;
...
general_settings_view_init(GeneralSettingsView *self)
{
    ...
    g_settings_bind(priv->settings, "quit-on-close",
                    priv->checkbutton_quitonclose, "active",
                    G_SETTINGS_BIND_DEFAULT);
...
general_settings_view_class_init(GeneralSettingsViewClass *klass)
{
    ...
    gtk_widget_class_bind_template_child_private(GTK_WIDGET_CLASS (klass), GeneralSettingsView, checkbutton_quitonclose);
