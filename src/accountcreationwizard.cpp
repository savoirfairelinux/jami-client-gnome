    ...
    priv->hash_updated = QObject::connect(
        ...
        [=] (Account::RegistrationState state) {
            switch(state)
            {
                ...
                {
                    //TODO: Diffrent error messages on ERROR_GENERIC
                    // and ERROR_NETWORK.
...
static void
existing_account_clicked(G_GNUC_UNUSED GtkButton *button, AccountCreationWizard *view)
{
    show_existing_account(view);
}
...
static void
new_account_clicked(G_GNUC_UNUSED GtkButton *button, AccountCreationWizard *view)
{
    show_account_creation(view);
}
...
static void
error_view_ok_clicked(G_GNUC_UNUSED GtkButton *button, AccountCreationWizard *view)
{
...
build_creation_wizard_view(AccountCreationWizard *view, bool show_cancel_button)
{
    ...
    /* error_view signals */
    g_signal_connect(priv->button_error_view_ok, "clicked", G_CALLBACK(error_view_ok_clicked), view);
