...
/**
 * This function is used instead of the standard attributes mapping for setting the column value by printing the alias
 * and the state of an account in combobox_account_selector.
 */
static void
