...
static void show_avatar_selection_dialog(G_GNUC_UNUSED GtkButton *button, RingMainWindow *win);
...
show_account_creation(RingMainWindow *win)
{
    ...
    /* connect signals */
    g_signal_connect(priv->button_avatar, "clicked", G_CALLBACK(show_avatar_selection_dialog), win);
...
static void
show_avatar_selection_dialog(G_GNUC_UNUSED GtkButton *button, RingMainWindow *win)
{
    RingMainWindowPrivate *priv = RING_MAIN_WINDOW_GET_PRIVATE(win);
