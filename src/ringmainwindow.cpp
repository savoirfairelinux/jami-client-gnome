...
alias_entry_changed(GtkEditable *entry, RingMainWindow *win)
{
    ...
    if (!alias || strlen(alias) == 0) {
        ...
        if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(priv->checkbutton_sign_up_blockchain))) {
            ...
            NameDirectory::instance().nameLookup(alias,[=](const QString& str, const NameDirectory::Response& status){
                switch(status) {
                    case NameDirectory::Response::notFound :
                    ...
                    break;
                    case NameDirectory::Response::found :
                    ...
                    break;
                    case NameDirectory::Response::error :
