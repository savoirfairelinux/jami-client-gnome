...
show_account_creation(RingMainWindow *win)
{
    ...
    /* set the click event to image_avatar */
    gtk_widget_set_events(priv->image_avatar, GDK_BUTTON_PRESS_MASK);
    ...
    g_signal_connect(priv->image_avatar, "button-press-event", G_CALLBACK(show_avatar_selection_widget), win);
