...
ring_init_lrc(RingMainWindow *win, const std::string& accountId)
{
    ...
    [win, priv] (const std::string& uid) { // [jn] à déplacer dans une fonction locale
     ...
     [win, priv] () { // [jn] à déplacer dans une fonction locale
    ...
    priv->showChatViewConnection_ = QObject::connect( // [jn] à déplacer dans une fonction locale
    ...
    priv->showCallViewConnection_ = QObject::connect( // [jn] à déplacer dans une fonction locale
    &priv->lrc_->getBehaviorController(),
    ...
    priv->showIncomingViewConnection_ = QObject::connect( // [jn] à déplacer dans une fonction locale
    &priv->lrc_->getBehaviorController(),
    ...
    priv->newAccountConnection_ = QObject::connect( // [jn] à déplacer dans une fonction locale
    ...
    priv->rmAccountConnection_ = QObject::connect( // [jn] à déplacer dans une fonction locale
    &priv->lrc_->getAccountModel(),
...
ring_main_window_init(RingMainWindow *win)
{
    ...
    [win, priv] (const std::string& accountId) { // [jn] à déplacer dans une fonction locale
        if (not priv->accountContainer_ ) {
