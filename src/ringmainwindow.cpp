...
on_redraw(GtkWidget*, cairo_t*, RingMainWindow* self)
{
    ...
    if (priv->dark_theme_enabled != current_theme) {
        priv->dark_theme_enabled = current_theme;
        ...
        .new-conversation-style:hover {  background: " + (priv->dark_theme_enabled ? "#003b4e" : "#bae5f0") + "; }";
