 ...
 * be empty, we want to ignore this; this returns TRUE if we should ignore the change and FALSE
 * otherwise.
 */
static gboolean
ignore_selection_change(GtkTreeSelection *selection){
...
{
    if (ignore_selection_change(selection)) return;
