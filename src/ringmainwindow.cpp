...
account_creation_next_clicked(G_GNUC_UNUSED GtkButton *button, RingMainWindow *win)
{
    ...
    /* destroy avatarmanipulation widget */
    g_clear_object(&priv->avatarmanipulation);
...
show_account_creation(RingMainWindow *win)
{
    ...
    gtk_box_pack_start(GTK_BOX(priv->box_avatarselection), priv->avatarmanipulation, true, true, 0);
