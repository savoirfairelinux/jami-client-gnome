...
private:
    ...
    void slotShowLetMessageView(lrc::api::conversation::Info conv);
...
CppImpl::updateLrc(const std::string& id, const std::string& accountIdToFlagFreeable)
{
    ...
    showLetMessageViewConnection_ = QObject::connect(&lrc_->getBehaviorController(),
                                               ...
                                               [this] (const std::string&, lrc::api::conversation::Info conv) { slotShowLetMessageView(conv); });
...
void
CppImpl::slotShowLetMessageView(lrc::api::conversation::Info conv)
{
