        ...
        priv->state_changed = QObject::connect(
            ...
            [=] (Account::RegistrationState state) {
                switch(state)
                {
                    ...
                    {
                        /* Keep waiting...
                        /* Before starting the migration, we are aleady in an ERROR state,
                        /* so there is no way of telling if the migration failed or if its
                        /* still ongoing.
                        /* TODO: possibly timeout after 30 seconds.
                        */
                        break;
                    }
                }
