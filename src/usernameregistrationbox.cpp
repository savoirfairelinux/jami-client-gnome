        ...
        [=] (G_GNUC_UNUSED const QString& accountId, NameDirectory::LookupStatus status, G_GNUC_UNUSED const QString& address, const QString& name) {
            ...
            switch(status)
            {
                ...
                case NameDirectory::LookupStatus::NOT_FOUND:
                {
                    ...
                    gtk_widget_show(priv->icon_username_availability);
                    g_signal_emit(G_OBJECT(view), username_registration_box_signals[USERNAME_AVAILABILITY_CHANGED], TRUE);
                    break;
                }
                case NameDirectory::LookupStatus::ERROR:
                {
                    ...
                    gtk_widget_show(priv->icon_username_availability);
                    g_signal_emit(G_OBJECT(view), username_registration_box_signals[USERNAME_AVAILABILITY_CHANGED], FALSE);
                    break;
                }
            }
        }
