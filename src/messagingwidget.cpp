...
GtkWidget*
messaging_widget_new(lrc::api::conversation::Info* conversation_,
                     AccountInfoPointer const & accountInfo)
{
    return (GtkWidget *) g_object_new(MESSAGING_WIDGET_TYPE, NULL);
}
...
messaging_widget_init(MessagingWidget *self)
{
    ...
    g_signal_connect(priv->button_end_without_message, "clicked", G_CALLBACK(on_leave_widget), view);
}
