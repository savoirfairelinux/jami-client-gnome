...
void       webkit_chat_container_print_history        (WebKitChatContainer *view, lrc::api::ConversationModel& conversation_model, const QString& convUid, lrc::api::MessagesList interactions);
void       webkit_chat_container_update_history       (WebKitChatContainer *view, lrc::api::ConversationModel& conversation_model, const QString& convUid, lrc::api::MessagesList interactions, bool all_loaded);
