...
current_call_view_dispose(GObject *object)
{
    ...
    g_source_remove(priv->smartinfo_action);
...
static void
toggle_smartinfo(GSimpleAction* action, GVariant* state, GtkWidget* vbox_call_smartInfo)
{
...
current_call_view_set_call_info(CurrentCallView *view, const QModelIndex& idx) {
    ...
    auto display_smartinfo = g_action_map_lookup_action(G_ACTION_MAP(g_application_get_default()), "display_smartinfo");
