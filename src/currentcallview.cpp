...
CppImpl::setCallInfo()
{
    ...
    remoteinfo_connection = QObject::connect(
        ...
        [this] (const QString& callId, const QString& contactId, const QString& peerName, bool state) {
            ...
            if (state) {
                ...
                gchar* value = g_strdup_printf("%s is recording", peerName.toStdString().c_str());
                ...
                gchar* value = g_strdup_printf("%s stopped recording", peerName.toStdString().c_str());
                gtk_label_set_text(GTK_LABEL(widgets->label_remoteRecord_information),value);
                g_free(value);
