...
struct _ChatViewPrivate
{
    ...
    Person        *person;
    ContactMethod *cm;
    std::shared_ptr<lrc::conversation::Info> conversation_; // TODO set const
...
GtkWidget *
chat_view_new (WebKitChatContainer* webkit_chat_container, std::shared_ptr<lrc::ConversationModel> conversationModel, std::shared_ptr<lrc::conversation::Info> conversation)
{
    ChatView *self = CHAT_VIEW(g_object_new(CHAT_VIEW_TYPE, NULL));
