...
private:
    ...
    void slotInteractionStatusUpdated();
    void slotConversationUpdated();
    ...
    interactionStatusUpdatedConnection_ =
        QObject::connect(&*accountInfo_->conversationModel,
                         ...
                         [this] (const QString&, const QString&,
                             ...
                             slotInteractionStatusUpdated();
                         });
    conversationUpdatedConnection_ =
        QObject::connect(&*accountInfo_->conversationModel,
                         &lrc::api::ConversationModel::conversationUpdated,
                         [this] (const QString&) {
                             slotConversationUpdated();
                         });
...
void
CppImpl::slotInteractionStatusUpdated()
{
    updateUrgency();
}
void
CppImpl::slotConversationUpdated()
{
    updateUrgency();
}
