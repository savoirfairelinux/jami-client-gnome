...
//         (GDestroyNotify)g_free);
    ...
    GtkCellRenderer *renderer = gtk_cell_renderer_text_new();
    GtkTreeViewColumn *column = gtk_tree_view_column_new_with_attributes(name, renderer, "text", column_idx, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW(treeview), column);
}
...
phonedirectory_view_init(PhonedirectoryView *self)
{
    ...
    GtkQTreeModel *model = gtk_q_tree_model_new(
        ...
        1, Qt::DisplayRole, G_TYPE_STRING,
        2, Qt::DisplayRole, G_TYPE_STRING,
        3, Qt::DisplayRole, G_TYPE_STRING,
        4, Qt::DisplayRole, G_TYPE_STRING,
        5, Qt::DisplayRole, G_TYPE_STRING,
        6, Qt::DisplayRole, G_TYPE_STRING,
        7, Qt::DisplayRole, G_TYPE_STRING,
        8, Qt::DisplayRole, G_TYPE_STRING,
        9, Qt::DisplayRole, G_TYPE_STRING,
        10, Qt::DisplayRole, G_TYPE_STRING,
        11, Qt::DisplayRole, G_TYPE_STRING,
        12, Qt::DisplayRole, G_TYPE_STRING,
        13, Qt::DisplayRole, G_TYPE_STRING,
        14, Qt::DisplayRole, G_TYPE_STRING,
        15, Qt::DisplayRole, G_TYPE_STRING,
        16, Qt::DisplayRole, G_TYPE_STRING,
        17, Qt::DisplayRole, G_TYPE_STRING,
        18, Qt::DisplayRole, G_TYPE_STRING,
        19, Qt::DisplayRole, G_TYPE_STRING
    );
    gtk_tree_view_set_model(GTK_TREE_VIEW(treeview), GTK_TREE_MODEL(model));

    add_text_column("URI", 0, GTK_TREE_VIEW(treeview));
    add_text_column("REGISTERED_NAME", 19, GTK_TREE_VIEW(treeview));
    ...
    add_text_column("HAS_CERTIFICATE", 15, GTK_TREE_VIEW(treeview));
    add_text_column("PRESENT", 16, GTK_TREE_VIEW(treeview));
    add_text_column("PRESENCE_MESSAGE", 17, GTK_TREE_VIEW(treeview));
    add_text_column("UID", 18, GTK_TREE_VIEW(treeview));
