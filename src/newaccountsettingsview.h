...
GtkWidget *new_account_settings_view_new           (GtkWidget* ring_main_window_pnt);
void       new_account_settings_view_show  (NewAccountSettingsView *self, gboolean show_profile);
