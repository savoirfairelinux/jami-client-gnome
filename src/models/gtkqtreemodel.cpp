...
/* Drag and Drop */
static void     gtk_q_tree_model_drag_source_init (GtkTreeDragSourceIface *iface);
static void     gtk_q_tree_model_drag_dest_init   (GtkTreeDragDestIface   *iface);
static gboolean gtk_q_tree_model_row_draggable         (GtkTreeDragSource *drag_source,
                                                        GtkTreePath       *path);
static gboolean gtk_q_tree_model_drag_data_delete      (GtkTreeDragSource *drag_source,
                                                        GtkTreePath       *path);
static gboolean gtk_q_tree_model_drag_data_get         (GtkTreeDragSource *drag_source,
                                                        GtkTreePath       *path,
                                                        GtkSelectionData  *selection_data);
static gboolean gtk_q_tree_model_drag_data_received    (GtkTreeDragDest   *drag_dest,
                                                        GtkTreePath       *dest,
                                                        GtkSelectionData  *selection_data);
static gboolean gtk_q_tree_model_row_drop_possible     (GtkTreeDragDest   *drag_dest,
...
static gboolean
gtk_q_tree_model_row_draggable(GtkTreeDragSource *drag_source,
                               GtkTreePath       *path)
{
...
static gboolean
gtk_q_tree_model_drag_data_delete(GtkTreeDragSource *drag_source,
                                  GtkTreePath       *path)
{
...
static gboolean
gtk_q_tree_model_drag_data_get(GtkTreeDragSource *drag_source,
                               GtkTreePath       *path,
                               GtkSelectionData  *selection_data)
{
...
static gboolean
gtk_q_tree_model_drag_data_received(GtkTreeDragDest   *drag_dest,
                                    GtkTreePath       *dest,
                                    GtkSelectionData  *selection_data)
{
...
static gboolean
gtk_q_tree_model_row_drop_possible(GtkTreeDragDest   *drag_dest,
                                   GtkTreePath       *dest_path,
						           GtkSelectionData  *selection_data)
{
