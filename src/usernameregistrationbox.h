...
GtkWidget *username_registration_box_new                           (Account *account, gboolean register_button, gboolean multi_line);
GtkEntry*  username_registration_box_get_entry                     (UsernameRegistrationBox *view);
void       username_registration_box_set_status_widgets_visible    (UsernameRegistrationBox* view, gboolean visible);
