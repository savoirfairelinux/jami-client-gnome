...
static void
activate_smart_list_item(GtkTreeSelection *selection, ConversationsView *self)
{
    GtkTreeIter iter;
...
conversations_view_init(ConversationsView *self)
{
    ...
    g_signal_connect(selectionNew, "changed", G_CALLBACK(activate_smart_list_item), self);
